...
interface AddCourseModalProps {
  ...
  availableCourses: Coursex[];
  onSelectCourse: (courseId: string) => void;
}

const AddCourseModal: React.FC<AddCourseModalProps> = ({ isOpen, onClose, onAddCourse, availableCourses, onSelectCourse }) => {
            ...
            <div className="max-h-64 overflow-y-auto">
              {filteredAvailableCourses.map(course => (
                ...
                >
                  ...
                  <p className="text-sm text-white/80">{course.id} • {course.semester}{course.semester == 1 ? 'st' : 'nd'} Semester</p>
                </div>
              ))}
            </div>
          </div>
