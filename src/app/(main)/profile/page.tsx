        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h1 className="text-3xl font-bold text-foreground">{lecturer.name}</h1>
                <div className="flex flex-col sm:flex-row sm:items-center mt-1 text-foreground/80">
                  <p className="text-base">{lecturer.department}</p>
                  <span className="hidden sm:block sm:mx-2 text-foreground/60">•</span>
                  <p className="text-base">ID: {lecturer.id}</p>
                </div>
              </div>
            </div>
            <div className="mt-6 md:mt-0 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 w-full md:w-auto">
